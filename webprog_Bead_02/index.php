...
<body>
	<div class="container">
		<header class="box-1"><?php include_once PROTECTED_DIR.'header.php'; ?></header>
		<nav class="box-1"><?php require_once PROTECTED_DIR.'nav.php'; ?></nav>
		<content class="box_1"><?php require_once PROTECTED_DIR.'routing.php'; ?></content>
